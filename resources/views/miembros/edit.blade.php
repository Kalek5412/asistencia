                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_apellido" class="form-control"
                                                    value="{{ $miembro->nombre_apellido }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="departamento"
                                                    value="{{ $miembro->departamento }}" class="form-control">
                                                @error('departamento')
                                                    <small style="color:red">*campo requerido</small>
                                                @enderror
                                            </div>
                                        ...
                                        <center>
                                            <output id="list">
                                                @if ($miembro->foto == '')
                                                    @if ($miembro->genero == 'MASCULINO')
                                                        <center>
                                                            <img src="{{ url('images/image-h.png') }}" alt=""
                                                                width="70%" height="70%">
                                                        </center>
                                                    @else
                                                        <center>
                                                            <img src="{{ url('images/image-m.png') }}" alt=""
                                                                width="70%" height="70%">
                                                        </center>
                                                    @endif
                                                @else
